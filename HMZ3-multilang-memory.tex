...
\renewcommand{\refname}{\small 1) 指针分析问题提出}
\begin{bibunit}
\nocite{weihl1980}
\putbib[pta]
\end{bibunit}

\renewcommand{\refname}{\small 2) 别名分析的出现}
\begin{bibunit}
\nocite{landi1992a,emami1994}
\putbib[pta]
\end{bibunit}

\renewcommand{\refname}{\small 3) 可计算性分析}
\begin{bibunit}
\nocite{landi1992b,ramalingam1994}
\putbib[pta]
\end{bibunit}

\renewcommand{\refname}{\small 4) Andersen/Steensgaard-型指针分析的提出}
\begin{bibunit}
\nocite{andersen1994,steensgaard1996}
\putbib[pta]
\end{bibunit}

\noindent \textbf{5) 提高分析精度}

\renewcommand{\refname}{\small \normalfont 上下文（调用点）敏感}
\begin{bibunit}
\nocite{shivers1991,horwitz1997,reps2000}
\putbib[pta]
\end{bibunit}
